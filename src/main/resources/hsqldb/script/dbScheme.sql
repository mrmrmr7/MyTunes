...
create table album (
    ...
    constraint album_author_id_fk foreign key (author_id) references author (id),
...
create table user_album (
    ...
    constraint user_album_user_fk  foreign key (user_id)  references users (id),
    constraint user_album_album_fk foreign key (album_id) references album (id)
    );
...
create table user_composition (
    ...
    user_id        int NOT NULL,
    composition_id int NOT NULL,
    constraint user_composition_composition_fk foreign key (composition_id) references composition (id),
    constraint user_composition_user_fk foreign key (user_id) references users (id)
    );

create table composition_feedback (
    id       int           NOT NULL,
    feedback varchar(5000) NOT NULL,
    constraint composition_feedback_composition_fk foreign key (id) references user_composition (id)
    );
