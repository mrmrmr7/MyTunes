        ...
        <div class="header-menu">
                ...
                <div class="header-left">
                    ...
                    <div class="dropdown for-notification">
                        ...
                        <div class="dropdown-menu" aria-labelledby="notification">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="${pageContext.request.contextPath}/#">
                                <i class="fa fa-check"></i>
                                <p>Server #1 overloaded.</p>
                            </a>
                            <a class="dropdown-item media bg-flat-color-4" href="${pageContext.request.contextPath}/#">
                                <i class="fa fa-info"></i>
                                <p>Server #2 overloaded.</p>
                            </a>
                            <a class="dropdown-item media bg-flat-color-5" href="${pageContext.request.contextPath}/#">
                    ...
                    <div class="dropdown for-message">
                        ...
                        <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-3" href="${pageContext.request.contextPath}/#">
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <a href="${pageContext.request.contextPath}/#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="user-avatar rounded-circle" src="${pageContext.request.contextPath}/site/images/admin.jpg" alt="User Avatar">
                    </a>

                    <div class="user-menu dropdown-menu">
                        <a class="nav-link" href="${pageContext.request.contextPath}/#"><i class="fa fa-user"></i> My Profile</a>

                        <a class="nav-link" href="${pageContext.request.contextPath}/#"><i class="fa fa-user"></i> Notifications <span class="count">13</span></a>
                ...
                <div class="language-select dropdown" id="language-select">
                    <a class="dropdown-toggle" href="${pageContext.request.contextPath}/#" data-toggle="dropdown"  id="language" aria-haspopup="true" aria-expanded="true">
