    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../site/./"><img src="images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="../site/./"><img src="images/logo2.png" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="../site/../index.jsp"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form action="${pageContext.request.contextPath}/crud" method="post" class="form-inline">
                            <div class="card">
                                <div class="card-header">
                                    <strong>USER</strong> DAO
                                </div>
                                    <div class="card-body card-block">
                                            <div class="form-group"><label class="pr-1  form-control-label">User id</label>
                                                <input type="text" id="exampleInputName23" name="id" placeholder="1-10" required="" class="form-control">
                                            </div>
                                            <input type="hidden" name="command" value="getUser"/>
                                    </div>
