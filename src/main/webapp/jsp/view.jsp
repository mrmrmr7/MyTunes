                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="${pageContext.request.contextPath}/site/#">
                                <span class="photo media-left"><img alt="avatar" src="${pageContext.request.contextPath}/static/images/avatar/1.jpg"></span>
                                ...
                                <a class="dropdown-item media bg-flat-color-4" href="${pageContext.request.contextPath}/site/#">
                                <span class="photo media-left"><img alt="avatar" src="${pageContext.request.contextPath}/static/images/avatar/2.jpg"></span>
                                <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-5" href="${pageContext.request.contextPath}/site/#">
                                <span class="photo media-left"><img alt="avatar" src="${pageContext.request.contextPath}/static/images/avatar/3.jpg"></span>
                                <span class="message media-body">
                                ...
                                <span class="photo media-left"><img alt="avatar" src="${pageContext.request.contextPath}/static/images/avatar/4.jpg"></span>
                                <span class="message media-body">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="${pageContext.request.contextPath}/site/#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="${pageContext.request.contextPath}/static/images/admin.jpg" alt="User Avatar">
                        </a>
