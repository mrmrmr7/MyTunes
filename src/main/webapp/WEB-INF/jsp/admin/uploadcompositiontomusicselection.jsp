            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-home-tab"href="${pageContext.request.contextPath}/crud?command=changeLang&from=/crud?command=viewUploadCompositionToMusicSelectionPage&lang=ru"
                               role="tab" aria-controls="pills-home" aria-selected="false">RU</a>
                        </li>
                        <li class="nav-item active ">
                            <a class="nav-link" id="pills-profile-tab" href="${pageContext.request.contextPath}/crud?command=changeLang&from=/crud?command=viewUploadCompositionToMusicSelectionPage&lang=en"
    ...
    <div class="content mt-3" style="width: 100%">
        ...
        <c:if test="${success}">
            <div class="sufee-alert alert with-close alert-dark alert-dismissible fade show">
                ...
                You successful add composition to music selection!
                        ...
                        <form action="${pageContext.request.contextPath}/crud" method="post" id="addUserBonusFormId" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="compositionNameId" name="compositionName" placeholder="Enter composition name"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="compositionPriceId" name="musicSelectionName" placeholder="Enter music selection name"
                                           class="form-control">
                                </div>
                            </div>
                            <input type="hidden" name="command" value="uploadCompositionToMusicSelection">
                        </form>
                    </div>
