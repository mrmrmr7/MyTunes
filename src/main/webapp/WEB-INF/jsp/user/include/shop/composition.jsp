            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-home-tab"href="${pageContext.request.contextPath}/crud?command=changeLang&from=/crud?command=compositionShop&lang=ru"
                               role="tab" aria-controls="pills-home" aria-selected="false">RU</a>
                        </li>
                        <li class="nav-item active ">
                            <a class="nav-link" id="pills-profile-tab" href="${pageContext.request.contextPath}/crud?command=changeLang&from=/crud?command=compositionShop&lang=en"
        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1><fmt:message key="shop.composition.info" bundle="${bundle}"/></h1>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li class="active"><fmt:message key="shop.composition.dashboard" bundle="${bundle}"/></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-3">
        ...
        <c:if test="${success}">
            <div class="sufee-alert alert with-close alert-dark alert-dismissible fade show">
                <span class="badge badge-pill badge-dark"><fmt:message key="shop.composition.success" bundle="${bundle}"/></span>
                <fmt:message key="shop.composition.buynextcomposition" bundle="${bundle}"/> ${compositionName}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong><fmt:message key="shop.composition" bundle="${bundle}"/></strong> <fmt:message key="shop.buy" bundle="${bundle}"/>
                        </div>
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-btn">
                                                <button class="btn" id="btnClass">
                                                    <i class="fa fa-buy"></i> <fmt:message key="shop.composition.button.buy" bundle="${bundle}"/>
                                                </button>
                                            </div>
                                            <input type="text" id="input" name="compositionName"
                                                   placeholder="<fmt:message key="usermusic.placeholder.compositionname" bundle="${bundle}"/>" class="form-control">
                                            <script>
                                        ...
                                        <table id="bootstrap-data-table-export"
                                            ...
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    style="width: 263px;"><fmt:message key="shop.composition.name" bundle="${bundle}"/>
                                                </th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="bootstrap-data-table-export" rowspan="1" colspan="1"
                                                    aria-label="Position: activate to sort column ascending"
                                                    style="width: 432px;"><fmt:message key="shop.composition.album" bundle="${bundle}"/>
                                                </th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="bootstrap-data-table-export" rowspan="1" colspan="1"
                                                    aria-label="Office: activate to sort column ascending"
                                                    style="width: 196px;"><fmt:message key="shop.composition.author" bundle="${bundle}"/>
                                                </th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="bootstrap-data-table-export" rowspan="1" colspan="1"
                                                    aria-label="Salary: activate to sort column ascending"
                                                    style="width: 157px;"><fmt:message key="shop.composition.price" bundle="${bundle}"/>
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody>
