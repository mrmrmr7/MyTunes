...
<body>
    ...
    <jsp:include page="/WEB-INF/jsp/include/clientleftpanel.jsp"/>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Insert</strong> author
                            </div>
                            <div class="card-body card-block">

                                <form action="${pageContext.request.contextPath}/crud" id="authorInsert" method="post" class="form-horizontal">
                                    <div class="form-group">
                                        <label class="pr-1  form-control-label">Login</label>
                                        <input type="text" id="authorFirstName" name="authorFirstName" placeholder="1-10" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="pr-1  form-control-label">Password</label>
                                        <input type="text" id="authorSecondName" name="authorSecondName" placeholder="1-10" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="pr-1  form-control-label">First name</label>
                                        <input type="text" id="authorPseudonim" name="authorPseudonim" placeholder="1-10" class="form-control">
                                    </div>
                                    <input type="hidden" name="command" value="authorInsert"/>
                                </form>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" form="authorInsert" class="btn btn-primary btn-sm">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-body card-block">
                                    <form action="${pageContext.request.contextPath}/crud" method="post" id="authorGetById" class="form-horizontal">
                                        ...
                                        <input type="hidden" name="command" value="authorGetById"/>

                                    </form>
                                </div>
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-sm" form="authorGetById">
                                    <i class="fa fa-dot-circle-o"></i> Submit
                                </button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Show all</strong> authors
                            </div>
                            <form action="${pageContext.request.contextPath}/crud" method="post" id="authorGetAllForm" class="form-horizontal">
                                <input type="hidden" name="command" value="authorGetAll"/>
                            </form>
                            <div class="card-footer">
                                <button type="submit" form="authorGetAllForm" class="btn btn-primary btn-sm">
                                    <i class="fa fa-dot-circle-o"></i> Submit
                                </button>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="${pageContext.request.contextPath}/crud" method="post" id="authorDeleteForm" class="form-horizontal">

                                    <div class="form-group">
                                        <label class="pr-1  form-control-label">Author id</label>
                                        <input type="text" id="authorDelete" name="id" placeholder="1-10" class="form-control">
                                    </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-sm" form="authorDeleteForm">
                                    <i class="fa fa-dot-circle-o"></i> Submit
                                </button>
