                            ...
                            <div class="tab-content pl-3 p-1" id="myTabContent">
                                ...
                                <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="showFeedbackTab">
                                    ...
                                    <c:if test="${success}">
                                        ...
                                        <div class="sufee-alert alert with-close alert-dark alert-dismissible fade show" style="margin-top: 1rem">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <table id="bootstrap-data-table-export"
                                                            ...
                                                            <c:forEach var="compositionFeedbackDto" items="${compositionFeedbackDtoList}">

                                                                <tr role="row" class="odd">
                                                                    <td class ="sorting_1"><c:out value="${compositionFeedbackDto.userName}"/></td>
                                                                    <td><c:out value="${compositionFeedbackDto.description}"/></td>
                                                                    <td><c:out value="${compositionFeedbackDto.timestamp}"/></td>
                                                                </tr>
                                ...
                                <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="addFeedbackTab">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="${pageContext.request.contextPath}/crud" method="post" id="addCompositionFeedbackForm" class="form-horizontal">
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Composition name</label></div>
                                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="compositionName" placeholder="Text" class="form-control"></div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Feedback</label></div>
                                                    <div class="col-12 col-md-9"><textarea name="compositionFeedback" id="textarea-input" rows="9" placeholder="Content..." class="form-control"></textarea></div>
                                                </div>
                                                <input type="hidden" name="command" value="addCompositionFeedback">
                                            </form>
                                        </div>
                                        <div class="card-footer"  style="background: white; margin: auto;">
                                            <button type="submit" class="btn btn-primary btn-sm" style="margin: auto;" form="addCompositionFeedbackForm">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table id="bootstrap-data-table-export1"
                                                        ...
                                                        <c:forEach var="compositionFeedbackDto" items="${userCompositionFeedbackList}">

                                                            <tr role="row" class="odd">
                                                                <td><c:out value="${compositionFeedbackDto.compositionName}"/></td>
                                                                <td><c:out value="${compositionFeedbackDto.description}"/></td>
                                                                <td><c:out value="${compositionFeedbackDto.timestamp}"/></td>
                                                            </tr>
