...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="site/images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="site/images/logo2.png" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.jsp"> <i class="menu-icon fa fa-dashboard"></i>My page</a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="site/tables-data.jsp">Data Table</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
    ...
    <script src="site/vendors/popper.js/dist/umd/popper.min.js"></script>
    <script src="site/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="site/assets/js/main.js"></script>


    <script src="site/vendors/chart.js/dist/Chart.bundle.min.js"></script>
    <script src="site/assets/js/dashboard.js"></script>
    <script src="site/assets/js/widgets.js"></script>
    <script src="site/vendors/jqvmap/dist/jquery.vmap.min.js"></script>
    <script src="site/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <script src="site/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script>
        (function($) {
            "use strict";
